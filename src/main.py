...
from noising import sp_noise, sce_filtering
...
if __name__ == "__main__":
    ...
    for filename in os.listdir(directory):
        ...
        stddev_image = get_noise_map_basic(noisy_image, 5)
        img_sce_sharp = sce_filtering(noisy_image, 1-sharped_image)
        img_sce_namfd = sce_filtering(noisy_image, 1-namfd_image)
